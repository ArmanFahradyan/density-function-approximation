...
from src.nn_solution.utils import criterion


def train(model, X, delta=0.1, lambda_=0.5, num_epochs=10000, lr=1e-3, a=-3, b=3):
    ...
    for epoch in range(num_epochs):
        ...
        # Forward pass
        outputs, _ = model(X)
        loss = criterion(outputs, labels, nn_outputs_1, nn_outputs_2, lambda_)
